<?php
    header( "refresh:5;url=signupAr.php" );
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse " id="navbarNavDropdown">
          <ul class="navbar-nav mr-auto w-100 justify-content-end">
            ...
            <li class="nav-item nlink mx-2">
              <a class="nav-link text-light" href="indexAr.php#contact_us">اتصل بنا</a>
            </li>         
    ...
    <div class="row g-3">
        ...
        <div class="row p-5 my-3 text-lg-right">
              <h1 data-aos="zoom-out-up" 
                        ...
                        data-aos-once="true"
               class="biggerTitle blurText greyColour "> <?php require_once 'Database/checklogin.php'; echo $_GET['username'];?> مرحبا</h1>
        </div>
        ...
        <div id="" > <!-- enter div id here -->
          <div class="p-5 col-lg-10 my-2 mx-5 bg-white rounded-3 ms-5 mb-5">
              ...
              <div class="border border-2 p-3 my-2 borderColour">
                ...
                <label for="" class="orangeColour biggerTitle p-5 col-lg-20 mx-5">شكرا لانشائك حساب جديد</label></br>
                <label for="" class="blueColour titleText">جاري التحويل ...</label></br>
                <p for="" class="blueColour smallText col-lg-20 " style="font-size: medium;">يمكمك التخطي عن طريق <a href="signup.php">الضغط هنا</a> </p>
                </div>
