    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse " id="navbarNavDropdown">
        ...
        <li class="nav-item nlink mx-2">
          ...
          <li class="nav-item nlink mx-2">
            <a class="nav-link text-light" href="../index.php#page-nested1">Contact Us</a>
          </li>
          ...
          <?php 
            if(isset($_SESSION['User'])) {
             ...
             if($_SESSION['User_Type'] =="Admin"){
              echo "<li><a class='dropdown-item' href='admin-verify-posts.php'><b>Admin Dashboard</b></a></li>";
             }else{
      ...
      <div class="col-lg-6 col-md-12 col-sm-12 donationForm">
        ...
        <!--missing person section-->
          <div class="p-5 my-2 bg-white rounded-3">
            ...
            <div class="row mx-1 mt-4 mediumText inputBlueBg">

              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">

                <p class="bold d-inline">Last Name: </p>
                <input type="text" id="mlastnameedit" name="mlastnameedit" 
                  class=" d-inline width-min mx-2 form-control form-control-lg" 
                  value="<?php echo $row['missing_person_last_name'];?>">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <input type="text" id="mtranlatededit" name="mtranlatededit" 
                  class="d-inline mx-2 width-min mx-2 form-control form-control-lg" 
                  value="<?php echo $row['missing_person_translated_names'];?>">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <input type="text" id="mfirstnameedit" name="mfirstnameedit" 
                  class="d-inline mx-2 width-min mx-2 form-control form-control-lg" 
                  value="<?php echo $row['missing_person_first_name'];?>">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <input type="text" id="dateDedit" name="dateDedit" 
                  class="d-inline mx-2 width-min mx-2 form-control form-control-lg" 
                  value="<?php echo $row['date_of_disappearance'];?>">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <input type="text" id="countryDedit" name="countryDedit" 
                  class="d-inline mx-2 width-min mx-2 form-control form-control-lg" 
                  value="<?php echo $row['country_of_disappearance'];?>">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <input type="text" id="placeDedit" name="placeDedit" 
                  class="d-inline mx-2 width-min mx-2 form-control form-control-lg" 
                  value="<?php echo $row['place_of_disappearance'];?>">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <input type="text" id="heightedit" name="heightedit" 
                  class="d-inline mx-2 width-min mx-2 form-control form-control-lg" 
                  value="<?php echo $row['missing_person_height'];?>">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <input type="text" id="weightedit" name="weightedit" 
                  class="d-inline mx-2 width-min mx-2 form-control form-control-lg" 
                  value="<?php echo $row['missing_person_weight'];?>">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                ...
                <textarea  rows = "5" cols = "" id="appearanceedit" name="appearanceedit" 
                  minlength="1" maxlength="1024" class="d-inline mx-2 mx-2 form-control form-control-lg">
            ...
            <div class="mx-3 mt-5">
              <p class="smallText">If this information matches what you are looking for,<br>
                ...
                <!--Contact find suri-->
                  ...
                  <button type="submit" id="admin_edit_post" name="admin_edit_post" class="btn smallText fw-bold btnBlue text-white mx-4 px-4">Save</button>
                </form> 

                <!--Go back to missing person inquery-->
                <a href="admin-verified-posts.php" class="text-decoration-none">
                  <button type="button" class="btn btnOrange smallText fw-bold text-white mx-3 px-3">Go Back</button>
                </a>
            </div>
            <?php } ?>  
          </div>
