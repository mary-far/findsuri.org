      ...
      <div class="col-lg-5 col-md-11 col-sm-11 description">
        <div class="row p-5 my-2 text-lg-right">
          <h1 data-aos="fade-right" 
              ...
              data-aos-once="false"
              class="greyColour blurText biggerTitle">Admin<br> Dashboard</h1>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row">
              <ul class="list-inline text-center">
                <li class="list-inline-item mx-3 regtext">
                  <a href="../Admindashboard/admin-verify-posts.php" class="blueColour noneLine">Pending Posts</a>
                </li>
                <li class="list-inline-item mx-3 regtext">
                  <a href="#" class="orangeColour ">Verified Posts</a> 
                </li>
                <li class="list-inline-item mx-3 regtext"> 
                ...
                <li class="list-inline-item mx-3 regtext">
                  <a href="./admin-messages.php" class="blueColour noneLine">Messages</a>
                </li>
              </ul>
            </div>
            ...
            <?php
              // here is the Database Connection
                ...
                if($conn->connect_error){
                  ...
                  $stmt = "SELECT * from verifypost where status ='Verified' ";
                    ...
                    <tbody class="align-middle mediumText">
                      ...
                      <?php
                        ...
                        ?>
                          ...
                          <td><?php echo $rowname['username'];?></td>
                          <td><?php echo $row['admin_id'];?></td>
                         
                          <form id="viewpost" action="admin_post_view.php" method="post" role="form">
                           <input type="text" name="post_id" value="<?php echo $row['post_id'];?>" hidden></input>
                           <td><button type="submit" class="btn btnOrange text-white mx-2">View/Edit</button></td>
                          </form>
                          <form id="operations" action="../Database/postoperations.php" method="post" role="form">
                            <input type="text" name="post_id" value="<?php echo $row['post_id'];?>" hidden></input>
                          <td><button id="admin_post_founded" name="admin_post_founded" class="btn btnBlue text-white mx-2">Found</button></td>
                          <td><button id="admin_archive_post" name="admin_archive_post" class="btn btn-dark text-white mx-2">Archive</button></td>
                          <td><button id="admin_delete_post" name="admin_delete_post" class="btn btnRed text-white mx-2">Delete</button></td>
                          </form>
    ...
    <div class="row align-items-center justify-content-center col-lg-12">
      ...
      <section class="layout-social container-fluid vertical-padding col-sm-5 col-md-5 col-lg-11">
        <div class="row text-start smallText">
          ...
          <div class="col-lg-2">
              <a href="../about.php" target="_blank" class="text-decoration-none">
