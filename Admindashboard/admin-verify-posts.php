            ...
            <div class="row">
              <ul class="list-inline text-center">
                <li class="list-inline-item mx-3 regtext">
                  <a href="#" class="orangeColour">Pending Posts</a>
                </li>
                <li class="list-inline-item mx-3 regtext">
            ...
            <?php
              // here is the Database Connection
                ...
                if($conn->connect_error){
                  ...
                  $stmt = "SELECT * from verifypost Where status='Pending' ";
                      ...
                      <?php
                        ...
                        ?>
                          ...
                          <form id="viewpost" action="admin_post_view.php" method="post" role="form">
                           ...
                           <td><button type="submit" class="btn btnOrange text-white mx-2">View</button></td>
                          </form>
                          <form id="operations" action="../Database/postoperations.php" method="post" role="form" >
                            <input type="text" name="post_id" value="<?php echo $row['post_id'];?>" hidden></input>
                          <td><button id="admin_verify_post" name="admin_verify_post" class="btn btnBlue text-white mx-2">Verify</button></td>
                          <td><button id="admin_ignore_post" name="admin_ignore_post" class="btn btnRed text-white mx-2">Ignore</button></td>
                          </form>
                        </tr>       
                      <?php } ?>
                   <?php } ?>  
