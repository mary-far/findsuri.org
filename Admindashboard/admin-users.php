          ...
          <div class="p-5 my-2 bg-white rounded-3">
            ...
            <div class="row">
              <ul class="list-inline text-center">
                ...
                <li class="list-inline-item mx-3 regtext">
                  <a href="#" class="orangeColour">Users</a>
                </li>
                <li class="list-inline-item mx-3 regtext">
              ...
              <div class="border border-2 p-3 my-2 borderColour rounded-3">
                ...
                ?>
                    <tbody class="align-middle mediumText">
                      <tr>
                          <td><?php echo $row['username'];?> <img width="18" height="18" src="<?php echo $imgsrc;?>" style="<?php echo $imgstyle;?>"></td>
                          <td><?php echo $row['user_email'];?></td>
                          <td><?php echo $row['date_of_join'];?></td>
                          <form id="operations" action="../Database/usersoperations.php" method="post" role="form">
                            <input type="text" name="user_id" value="<?php echo $row['user_id'];?>" hidden></input>
                          <td><button id="admin_delete_user" name="admin_delete_user" class="btn btnRed text-white mx-2">Delete</button></td>
                          </form>
                      </tr>      
                      <?php } ?>           
                  </tbody>
