<?php
   header( "refresh:5;url=missing-persons-inquiry.php" );
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container-fluid">
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown">
            ...
            <a class="dropdown-item" href="thankspageAr.php"> العربية</a>
    ...
    <div class="row g-3">
        ...
        <div class="row p-5 my-3 text-lg-right">
              <h1 data-aos="zoom-out-up" 
                        ...
                        data-aos-once="true"
               class="biggerTitle blurText greyColour ">Thank you</h1>
        </div>
        ...
        <div id="" > <!-- enter div id here -->
          <div class="p-5 col-lg-10 my-2 mx-5 bg-white rounded-3 ms-5 mb-5">
              ...
              <div class="border border-2 p-3 my-2 borderColour">
                ...
                <label for="" class="orangeColour biggerTitle p-5 col-lg-20  mx-5 ">Thank you for trusting Findsuri!</label>
                <label for="" class="blueColour titleText">Your inquiry has been submitted
                Please check your user dashboard for updates 
                Once it's approved it will be published on out website </label></br></br>
                <label for="" class="blueColour smallText ">redirecting...</label>
                <p for="" class="blueColour smallText  " style="font-size: medium;">Or you can  <a href="signup.php">click here</a></p>
                </div>
