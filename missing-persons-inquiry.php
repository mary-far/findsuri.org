      ...
      <div class="container-fluid">
        ...
        <div class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown">
            ...
            <a class="dropdown-item" href="missing-persons-inquiryAr.php"> العربية</a>
          ...
          <div class="p-5 my-2">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 mt-2">
                <div class="dropdown">
                  <label class="text-white px-3">Sort by</label>
                  <button class="btn btn-light smallText btnWhite" type="button"
                          id="filterMenu" name="filterMenu" data-toggle="dropdown"
                          aria-haspopup="true" aria-expanded="false">
                          All cases <i class="fa-solid fa-sliders ms-5 ps-3"></i>
                  </button>
                  <!--sort dropdown menu options-->
                <form id="filterform" action="" method="post" role="form">
                  <ul class="dropdown-menu checkbox-menu allow-focus px-3" aria-labelledby="filterMenu">
                    <li >
                      <label  class="text-white">
                        <input type="checkbox" name="age" onchange="this.form.submit()" <?=(isset($_POST['age'])?' checked':'')?>> Age
                      </label>
                    </li>
                    
                    <li >
                      <label class="text-white">
                        <input type="checkbox" name="gender" onchange="this.form.submit()" <?=(isset($_POST['gender'])?' checked':'')?>> Gender
                      </label>
                    </li>
                    
                    <li >
                      <label  class="text-white">
                        <input type="checkbox" name="country" onchange="this.form.submit()" <?=(isset($_POST['country'])?' checked':'')?>> Country
                      </label>
                    </li>

                    <li >
                      <label  class="text-white">
                        <input type="checkbox" name="date" onchange="this.form.submit()" <?=(isset($_POST['date'])?' checked':'')?>> Date
                      </label>
                    </li>
                  </ul>
              ...
              <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
               ...
               <!-- <form id="search" action="" method="post" role="form">-->
                  <input type="text" name="searchboxvalue" class=" smallText form-control btnWhite" placeholder="Search" value="<?php 
                  ...
                  <button type="submit" name="searchbox"  class="btn btnWhite layer-back">
                    <i class="fa-solid fa-magnifying-glass blueColour px-0 mx-0 smallText"></i></button>
            ...
            <?php
             ...
             while($row = mysqli_fetch_assoc($result)){
              if($row['status']=="Founded"){
                ...
                echo "<h3 class='blueColour bold textbar'>Case Closed</h3>";
                echo "</div>";
                echo "</div> ";
                echo "</div>";
              }else{
             ...
             //--Hover over information and button-->
              ...
              echo "<form id='view-post' action='missing_person_info.php' method='post' role='form'>";
              echo "<input type='text' name='post_id' value='".$row['post_id']."' hidden></input>";
              echo "<button id='view-post' name='view-post' type='submit' class='btn fw-bold text-light smallText btnBlue px-5 mt-2'>View</button>";
              echo "</form>";
              echo "</div>";     
